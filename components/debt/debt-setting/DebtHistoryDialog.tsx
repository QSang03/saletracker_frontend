        ...
        <TableRow>
          <TableCell colSpan={3} className="h-[300px] text-center">
            <div className="flex flex-col items-center justify-center py-8">
              ...
              <div className="text-lg font-medium bg-gradient-to-r from-slate-600 via-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">
      ...
      return (
        ...
        >
          ...
          <TableCell className="text-center font-medium px-4 py-3 relative z-10 w-20">
            {/* ✨ Particle effects trong cell này */}
          ...
          <TableCell className="text-center px-4 py-3 relative z-10 w-25">
            ...
            <div className="flex items-center justify-center relative z-10">
              <div className="relative group/btn">
                ...
                >
                  {/* Multi-layer quantum field borders */}
                  ...
                  {/* MEGA ENHANCED: Main Eye icon với đầy đủ WOW effects */}
                  <div className="relative z-10 group-hover/btn:animate-pulse">
                    ...
                    {/* Main Eye with multiple transformations */}
                  ...
                  {/* Holographic overlay với rainbow effect */}
                  <div className="absolute inset-0 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-400 rounded-xl overflow-hidden">
  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={onClose}>
        <DialogContent className="!w-[50vw] !max-w-[50vw] !h-[80vh] !max-h-[80vh] flex flex-col">
          ...
          <div className="flex-1 flex flex-col min-h-0 relative z-10">
            ...
            >
              <div className="flex-1 min-h-0 max-h-[60vh] border border-slate-200/50 rounded-xl bg-white/95 backdrop-blur-sm shadow-xl overflow-hidden">
