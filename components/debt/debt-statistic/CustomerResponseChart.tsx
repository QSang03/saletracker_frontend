...
import { MessageSquare, Users, Bell, CheckCircle2, AlertCircle, RotateCcw, Sparkles, TrendingUp, BarChart3 } from 'lucide-react';
  ...
  const ChartTypeSelector = React.memo<{ 
    ...
    return (
      <div className="relative">
        <div className="absolute -inset-1 bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 rounded-2xl blur opacity-30 animate-pulse"></div>
