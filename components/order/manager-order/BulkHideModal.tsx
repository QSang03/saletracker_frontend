...
const BulkHideModal: React.FC<BulkHideModalProps> = ({
  selectedOrders,
  isOpen,
  onClose,
  onConfirm,
          ...
          <div className="relative bg-gradient-to-br from-white via-amber-50 to-orange-50 backdrop-blur-xl rounded-3xl shadow-2xl">
            ...
            <DialogHeader className="relative p-8 pb-4">
              ...
              <DialogTitle className="text-center text-2xl font-bold bg-gradient-to-r from-amber-600 via-orange-600 to-yellow-600 bg-clip-text text-transparent mb-2">
                👁️‍🗨️ Ẩn {selectedOrders.length} đơn hàng
              </DialogTitle>
              ...
              <DialogDescription className="text-center text-base text-gray-600 font-medium max-w-md mx-auto leading-relaxed">
                ...
                đơn hàng đã chọn. Bạn có thể khôi phục sau tại trang{" "}
            ...
            <div className="px-8 pb-8 space-y-6">
              ...
              <div className="relative group">
                ...
                <div className="relative max-h-40 overflow-y-auto border-2 border-amber-200 rounded-2xl p-4 bg-gradient-to-br from-amber-50 to-white shadow-inner">
                  <Label className="flex items-center gap-2 text-sm font-bold text-gray-700 mb-3">
                    <EyeOff className="w-4 h-4 text-amber-500" />
                    Danh sách đơn hàng sẽ bị ẩn:
                  </Label>
                  ...
                  <div className="space-y-2">
                    {selectedOrders.slice(0, 5).map((order, index) => (
                      <div
                        key={order.id}
                        className="text-sm bg-white rounded-xl p-3 shadow-sm border border-amber-100 hover:shadow-md transition-shadow duration-200 hover:scale-[1.02] transform"
                    ...
                    {selectedOrders.length > 5 && (
                      <div className="text-center py-2">
                        <div className="inline-flex items-center gap-2 text-sm text-gray-500 bg-gradient-to-r from-amber-100 to-orange-200 px-4 py-2 rounded-full font-medium">
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <div className="flex items-center justify-center gap-2 relative z-10">
                        <ChevronDown className="w-4 h-4 group-hover:scale-110 transition-transform duration-300 rotate-180" />
            ...
            <div className="flex justify-end gap-4 p-8 pt-0">
              ...
              {/* Hide Button - Matching the original button style */}
              <Button
                type="button"
